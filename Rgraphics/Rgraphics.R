...
setwd('C:/Users/amit.dingare/Documents/Rapid Eagle/Rgraphics')
...
ggplot(subset(housing, State %in% c("MA", "TX")),
       aes(x=Date,
           ...
           color=State))+
  geom_point() +
  scale_y_continuous("Home Value",labels = comma)
...
#hp2001Q1 <- subset(housing, date =2001)
hp2001Q1 <- housing[housing$Date=="2001",]
ggplot(hp2001Q1,
...
ggplot(hp2001Q1,
  ...
  geom_point(aes(color=Home.Price.Index)) +
...
##   The most frequent  qestion that anyone working in this area
##   goes something like this: 
##   I have two variables in my data.frame, and I'd like to plot them as separate
